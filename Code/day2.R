...
library(dplyr)
data = readLines("~/Google Drive/Lorenzo/AdventCalendar/input2.txt")
data = data.frame(do.call(rbind, Map(function(x) { matrix(sort(as.numeric(x)), nrow = 1)}, strsplit(data, "x", fixed = T))))
